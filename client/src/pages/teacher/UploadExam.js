    ...
    <div>
      <div className="header">
        <div className="header-content">
          <div>
            <h1 className="text-xl">上傳檔案建立測驗</h1>
            <p className="text-muted mt-sm">支援 .docx 及 .txt 格式</p>
          </div>
      ...
      <div className="container">
        ...
        <div className="card">
          <h2 className="text-lg mb-20">步驟 1：選擇檔案</h2>
        ...
        {preview && (
          <div className="card">
            <h2 className="text-lg mb-20">步驟 2：確認解析結果</h2>
            ...
            {preview.parsed.parts.length === 0 ? (
              ...
              <>
                ...
                {preview.parsed.parts.map((part, partIndex) => (
                  <div key={partIndex} className="card card-muted">
                    <h3 className="mb-10">{part.title}</h3>
                    {part.description && (
                      <p className="text-muted mb-10">{part.description}</p>
                    )}
        ...
        {preview && preview.parsed.parts.length > 0 && (
          <div className="card">
            <h2 className="text-lg mb-20">步驟 3：建立測驗</h2>
        ...
        <div className="card">
          <h2 className="text-lg mb-20">Word 文件格式說明</h2>
          <div className="prose">
            <p>系統會自動解析以下格式：</p>
